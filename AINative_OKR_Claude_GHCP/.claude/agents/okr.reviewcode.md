...
2. Load reference documents:
   - `docs/output/specs/<feature-id>/spec.md` — feature spec
   - `docs/output/specs/<feature-id>/tasks.md` — task completion checklist
   - `docs/output/specs/<feature-id>/plan.md` — implementation plan
   - `docs/output/specs/<feature-id>/data-model.md` — entity model
